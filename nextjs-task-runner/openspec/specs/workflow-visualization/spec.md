...
## Purpose
This specification defines the global sidebar navigation and the workflow visualization dashboard. The sidebar provides easy access to the Home and Workflow pages, while the dashboard allows users to visualize task execution flows using `@calmo/task-runner` and Mermaid diagrams.
## Requirements
